   ...
   <example>
     ...
     <file name="protractor.js" type="protractor">
       it('should init with 1234.56', function() {
         expect(element(by.id(currency.jsx)).getText()).toBe('$1,234.56');
         expect(element(by.binding(currency.jsx)).getText()).toBe('USD$1,234.56');
       });
       it('should update', function() {
         ...
         expect(element(by.id(currency.jsx)).getText()).toBe('($1,234.00)');
         expect(element(by.binding(currency.jsx)).getText()).toBe('(USD$1,234.00)');
       });
     </file>
   </example>
 */
